...
public class NotAuthorizedException extends RuntimeException {
    ...
    public NotAuthorizedException(StatusCode statusCode) {
        super(statusCode.getDescription());
        this.statusCode = statusCode;
        this.statusType = StatusType.ERROR;
    }

    public NotAuthorizedException(StatusCode statusCode, StatusType statusType) {
        super(statusCode.getDescription());
        this.statusCode = statusCode;
        this.statusType = statusType;
    }

    public NotAuthorizedException(StatusCode statusCode, Throwable cause) {
        super(statusCode.getDescription(), cause);
        this.statusCode = statusCode;
        this.statusType = StatusType.ERROR;
    }

    public NotAuthorizedException(StatusCode statusCode, StatusType statusType, Throwable cause) {
        super(statusCode.getDescription(), cause);
        this.statusCode = statusCode;
        this.statusType = statusType;
    }
